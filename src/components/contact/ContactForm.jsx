...
function ContactForm() {
  return (
    <section className="bg-white -900 w-full h-full pt-20 home-contact-bg" style={{fontFamily:"Gilroy-Medium"}}>
      <div className="container px-6 py-12 mx-auto">
        <div className="lg:flex lg:items-center lg:-mx-6">
          <div className="lg:w-1/2 lg:mx-6">
            <h1 className="text-2xl text-white capitalize  lg:text-3xl" style={{fontFamily:"Gilroy-SemiBold"}}>
              Contact us for <br /> more info
            </h1>

            <div className="mt-6 space-y-8 -8">
              <p className="flex items-start -mx-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-6 h-6 mx-2 text-slate-400 -400"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  stroke-width="2"
                ...
                <span className="mx-2 text-white truncate w-72 -400">
                  Köprübaşı Mahallesi Selanik Caddesi No: 235/A Tekkeköy, Samsun
                  / TURKEY
                </span>
              </p>
            ...
            <div className="mt-6 w-80">
              ...
              <div className="flex mt-4 -mx-1.5 ">
                <a
                  className="mx-1.5 -red-400 text-gray-400 transition-colors duration-300 transform hover:text-slate-400"
                  href="##"
                >
                  <svg
          ...
          <form
            className="relative mx-7 -auto py-12 px-7 w-1/2  flex flex-col -6 gap-4 rounded-3xl"
            style={{
          ...
          >
            ...
            <div className="form-input w-full flex justify-center items-center -end flex-col -2 mt-4 -0">
              <button
                className=" w-[200px] border border-solid hover:bg-white text-white hover:text-slate-400 py-2 transition-all duration-300 rounded-xl font-semibold"
